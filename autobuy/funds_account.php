...
$file = json_decode(HttpGet("https://economy.roblox.com/v1/users/$currentuserid/currency", $RobloSecurity), true);
$file1 = json_decode(HttpGet("https://economy.roblox.com/v1/users/$currentuserid/revenue/summary/year", $RobloSecurity), true);
